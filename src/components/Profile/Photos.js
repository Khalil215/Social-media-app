...
export default function Photos({ posts }) {
  ...
  // console.log(posts);
  return !posts ? (
    <SkeletonTheme baseColor="#162329" highlightColor="#193741" ><div className='profilePhotos'><Skeleton height={400} width={300} count={1} /><Skeleton height={400} width={300} count={1} /><Skeleton height={400} width={300} count={1} /></div></SkeletonTheme>) : posts?.length > 0 ? (
      <div
